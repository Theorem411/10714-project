...
def batchify(data, batch_size, device, dtype):
    ...
    data = data[:n_batches * batch_size] # trimming excess
    data = np.array(data, dtype=dtype) # constructing 1D array
    return np.ascontiguousarray(data.reshape((batch_size, n_batches)).T)
    ### END YOUR SOLUTION
