...
class BatchNorm1d(Module):
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        if self.training:
          ...
          x_std = x_minus_u / ((ops.broadcast_to(self.running_var.reshape((1, self.running_var[0])), x.shape) + self.eps)**0.5) # ops.divide(x_minus_u, ops.power_scalar(ops.add_scalar(self.running_var, self.eps), 0.5))
